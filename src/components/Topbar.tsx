    ...
    >
      ...
      <div style={{ position: 'relative' }}>
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 6, background: 'transparent', border: 0, cursor: 'pointer', padding: 4, color: 'var(--color-neutral-300)' }}
        >
          <div className="avatar-chip" style={{ width: 34, height: 34, background: 'var(--color-accent-100)', color: 'var(--color-accent-400)' }}>
